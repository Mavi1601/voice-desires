  ...
  try {
    ...
    const response = await fetch("https://api.openai.com/v1/chat/completions", {
      ...
      headers: {
        ...
        "Authorization": "Bearer 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"
      },
      body: JSON.stringify({
        model: "gpt-4",
